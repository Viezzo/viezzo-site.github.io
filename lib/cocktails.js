$(document).ready(function() {
    ...
    function createDatabase() {
        ...
        AReview = "It was okay. Thesoda was flat and the Champagne I used was less sweet than the Prosecco that's usually recommended.";
        ...
        LReview = "";
        window.cocktailDatabase.cocktails.push(new Cocktail(
            "Port Collins", "0.75 Whiskey, 0.75 Port Wine, 0.75 Simple syrup, 0.75 Lemon juice", 
            "Lemon peel",
