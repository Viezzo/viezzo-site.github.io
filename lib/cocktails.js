$(document).ready(function() {
    ...
    function createDatabase() {
        ...
        window.cocktailDatabase.cocktails.push(new Cocktail(
            "Pink Potion", "1 Gin, 0.75 Italicus Bergamotto, 0.5 Yellow Chartreuse, 0.75 Grapefruit juice, 0.75 Lemon juice, 0 Cardamom, 0 Basil, 0 White Peppercorns", 
            "Grapefruit peel",
            "OG",
            7, 7, 7, 6, AReview, 
            6.5, 7, 8, 6, LReview));
        ...
        window.cocktailDatabase.cocktails.push(new Cocktail(
            "Pink Poison", "1 Liquor 43, 0.5 Mezcal, 0.5 Genepy, 0.5 Italicus Bergamotto, 0.25 Grapefruit Juice, 3 dashes chocolate bitters", 
            "Grapefruit peel",
            "OG",
            5, 8, 7, 8, AReview, 
            6, 7, 7, 8, LReview));
        ...
        window.cocktailDatabase.cocktails.push(new Cocktail(
            "Lupe's Sangria", "2 Moscato, 0.5 Vodka, 0.5 Triple Sec, 2 Grapefruit juice", 
            "Grapefruit peel",
            "OG",
            3, 8, 4, 3, AReview, 
            3, 7, 4, 3, LReview));
