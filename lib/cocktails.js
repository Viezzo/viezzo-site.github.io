$(document).ready(function() {
    ...
    function createDatabase() {
        ...
        //cordials
        window.ingredientDatabase.ingredients.push(new Ingredient(
            "liquor 43", 31, "cordial", ['liquor 43'], 1.06));   
        window.ingredientDatabase.ingredients.push(new Ingredient(
        ...
        //bitters
        window.ingredientDatabase.ingredients.push(new Ingredient(
            "chocolate bitters", 44, "bitters", ['dashes chocolate bitters', 'dash chocolate bitters'], 2.8)); //28% and $0.25 per oz, but 1 dash is 1/32 oz, so each unit is smaller
        window.ingredientDatabase.ingredients.push(new Ingredient(
        ...
        window.ingredientDatabase.ingredients.push(new Ingredient(
            "grapefruit", 0, "juice", ['grapefruit'], 0.75));  
        window.ingredientDatabase.ingredients.push(new Ingredient(
        ...
        window.cocktailDatabase.cocktails.push(new Cocktail(
            "Paris", "1.5 Bourbon, 0.5 Chambord, 2 dashes Angostura bitters", 
            "Luxardo Cherry",
            "Drizly (French Manhattan)",
            6, 8.5, 6, 8, AReview, 
            6, 8.5, 7, 8, LReview));
        ...
        window.cocktailDatabase.cocktails.push(new Cocktail(
            "Pink Potion", "1 Gin, 0.75 Italicus Bergamotto, 0.5 Yellow Chartreuse, 0.75 Grapefruit, 0.75 Lemon juice, 0 Cardamom, 0 Basil, 0 White Peppercorns", 
            "Grapefruit peel",
            "OG",
            7, 7, 7, 6, AReview, 
            6.5, 7, 8, 6, LReview));
        ...
        AReview = "Tasty, on the sweet side.";
        LReview = "Sweet, a little strong.";
        window.cocktailDatabase.cocktails.push(new Cocktail(
            "Pink Poison", "1 Liquor 43, 0.5 Mezcal, 0.5 Genepy, 0.5 Italicus Bergamotto, 0.25 Grapefruit, 3 dashes chocolate bitters", 
            "Grapefruit peel",
            "OG",
            5, 8, 7, 8, AReview, 
            6, 7, 7, 8, LReview));

        AReview = "Fruit punch-y but tasty.";
        LReview = "I enjoyed it, but it's a half-assed sangria. Substitute with any ingredients you have on han. Looks pretty though.";
        window.cocktailDatabase.cocktails.push(new Cocktail(
            "Lupe's Sangria", "2 Moscato, 0.5 Vodka, 0.5 Triple Sec, 2 Grapefruit", 
            "Grapefruit peel",
            "OG",
            3, 8, 4, 3, AReview, 
            3, 7, 4, 3, LReview));
